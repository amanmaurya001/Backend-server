...
import { addressValidator ,editAddressValidator} from "../validator/val-address.js";
const router = express.Router();
router.post("/createAdress",isLoggedIn,addressValidator,createAddress );
router.get("/showAdress",isLoggedIn,showAddress );
router.get("/editShowAdress/:addressId",isLoggedIn,editAddressValidator,editAddressDataShow );
